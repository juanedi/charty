...
var _user$project$Charty_ArrayUtil$maximum = function () {
	var combine = F2(
		function (x, r) {
			return _elm_lang$core$Maybe$Just(
				A2(
...
var _user$project$Charty_ArrayUtil$unsafeMaximum = function (a) {
	var _p0 = _user$project$Charty_ArrayUtil$maximum(a);
	if (_p0.ctor === 'Nothing') {
		return _elm_lang$core$Native_Utils.crashCase(
			'Charty.ArrayUtil',
			{
...
var _user$project$Charty_ArrayUtil$unsafeGet = F2(
	function (i, array) {
...
var _user$project$Charty_ArrayUtil$unsafeFirst = function (array) {
	return A2(_user$project$Charty_ArrayUtil$unsafeGet, 0, array);
};
var _user$project$Charty_ArrayUtil$unsafeLast = function (array) {
	return A2(
		_user$project$Charty_ArrayUtil$unsafeGet,
		_elm_lang$core$Array$length(array) - 1,
		array);
};

var _user$project$Charty_Color$defaultPalette = _elm_lang$core$Array$fromList(
	{
		ctor: '::',
		_0: '#4D4D4D',
		_1: {
...
var _user$project$Charty_Color$assignDefaults = function (dataset) {
	var colorCount = _elm_lang$core$Array$length(_user$project$Charty_Color$defaultPalette);
	var color = function (index) {
		return A2(
			_user$project$Charty_ArrayUtil$unsafeGet,
			A2(_elm_lang$core$Basics_ops['%'], index, colorCount),
			_user$project$Charty_Color$defaultPalette);
	};
	return A2(
...
var _user$project$Charty_Labels$labelRow = F3(
...
var _user$project$Charty_Labels$drawLabels = F2(
	function (config, slices) {
		var labels = function (slices) {
			return A2(
				_elm_lang$core$List$indexedMap,
				_user$project$Charty_Labels$labelRow(config),
				slices);
		};
		return A2(
			_elm_lang$svg$Svg$g,
...
var _user$project$Charty_Labels$withLabels = F3(
		...
		return A2(
			...
			},
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: A2(_user$project$Charty_Labels$drawLabels, config, labels),
						_1: {ctor: '[]'}
					}
				}
			});
	});
var _user$project$Charty_Labels$Config = F2(
	function (a, b) {
		return {background: a, labelsColor: b};
	});

var _user$project$Charty_SelectList$include = _elm_lang$core$Maybe$Just;
var _user$project$Charty_SelectList$maybe = _elm_lang$core$Basics$identity;
var _user$project$Charty_SelectList$iff = F2(
	function (include, x) {
		return include ? _elm_lang$core$Maybe$Just(x) : _elm_lang$core$Maybe$Nothing;
	});
var _user$project$Charty_SelectList$unless = F2(
	function (exclude, x) {
		return A2(_user$project$Charty_SelectList$iff, !exclude, x);
	});
var _user$project$Charty_SelectList$select = A2(
	_elm_lang$core$List$foldr,
	F2(
		function (item, rec) {
			var _p0 = item;
...
var _user$project$Charty_LineChart$drawPoint = F3(
	function (transform, color, point) {
		...
		return A2(
			...
			_user$project$Charty_SelectList$select(
				{
					ctor: '::',
					_0: _user$project$Charty_SelectList$include(
...
var _user$project$Charty_LineChart$drawPoints = F2(
	function (transform, _p1) {
		...
		return A2(
			...
			A2(
				_elm_lang$core$List$map,
				A2(_user$project$Charty_LineChart$drawPoint, transform, _p2._0),
				_p2._1.data));
	});
var _user$project$Charty_LineChart$drawLine = F2(
...
var _user$project$Charty_LineChart$initTransform = F2(
	function (_p9, _p8) {
		var _p10 = _p9;
		var _p11 = _p8;
		var _p15 = _p11.top;
...
var _user$project$Charty_LineChart$gsub = F2(
...
var _user$project$Charty_LineChart$label = function (precision) {
	return function (_p16) {
		return A3(
			_user$project$Charty_LineChart$gsub,
			'\\.0+$',
			'',
			A2(_myrho$elm_round$Round$ceiling, precision, _p16));
	};
};
var _user$project$Charty_LineChart$axis = F2(
						...
						_0: A2(
							...
							},
							{
								...
								_0: _elm_lang$svg$Svg$text(
									A2(_user$project$Charty_LineChart$label, cfg.labelPrecision, yVal)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Charty_LineChart$initPadding = F2(
			...
			return function (n) {
				...
				_elm_lang$core$String$length(
					A3(
						...
						'\\.',
						'',
						A2(_user$project$Charty_LineChart$label, cfg.labelPrecision, _p22))));
		};
		var leftOffset = _user$project$Charty_ArrayUtil$unsafeMaximum(
			A2(_elm_lang$core$Array$map, labelOffset, yLabels));
		return {top: 50, right: 50, bottom: 50, left: leftOffset};
	});
var _user$project$Charty_LineChart$initYLabels = F2(
	function (yMin, yMax) {
...
var _user$project$Charty_LineChart$initDrawingSettings = F2(
	function (cfg, dataset) {
		...
		if (((((_p27.ctor === '_Tuple4') && (_p27._0.ctor === 'Just')) && (_p27._1.ctor === 'Just')) && (_p27._2.ctor === 'Just')) && (_p27._3.ctor === 'Just')) {
			var yLabels = A2(_user$project$Charty_LineChart$initYLabels, _p27._2._0, _p27._3._0);
			var bounds = {
				xMin: _p27._0._0,
				xMax: _p27._1._0,
				yMin: _user$project$Charty_ArrayUtil$unsafeFirst(yLabels),
				yMax: _user$project$Charty_ArrayUtil$unsafeLast(yLabels)
			};
			var padding = A2(_user$project$Charty_LineChart$initPadding, cfg, yLabels);
			return {
				padding: padding,
				transform: A2(_user$project$Charty_LineChart$initTransform, bounds, padding),
				yLabels: yLabels
			};
		} else {
			...
			return {
				padding: padding,
				transform: A2(
					_user$project$Charty_LineChart$initTransform,
...
var _user$project$Charty_LineChart$addLabels = F3(
	function (cfg, chart, labels) {
		return A3(
			_user$project$Charty_Labels$withLabels,
			{background: cfg.background, labelsColor: '#333333'},
			labels,
			chart);
	});
var _user$project$Charty_LineChart$view = F2(
	function (cfg, dataset) {
		var seriesWithColors = cfg.colorAssignment(dataset);
		var drawingSettings = A2(_user$project$Charty_LineChart$initDrawingSettings, cfg, dataset);
		var lines = A2(
			_elm_lang$core$List$map,
			_user$project$Charty_LineChart$drawLine(drawingSettings.transform),
			seriesWithColors);
		var points = cfg.drawPoints ? A2(
			_elm_lang$core$List$map,
			_user$project$Charty_LineChart$drawPoints(drawingSettings.transform),
		...
		var chart = function (attrs) {
			return A2(
				...
				},
				{
					...
					_1: {
						ctor: '::',
						_0: A2(_user$project$Charty_LineChart$axis, cfg, drawingSettings),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$svg$Svg$g,
		...
		return cfg.drawLabels ? A3(
			_user$project$Charty_LineChart$addLabels,
			cfg,
			chart(
				{
					ctor: '::',
...
var _user$project$Charty_LineChart$defaults = {drawPoints: true, background: 'transparent', colorAssignment: _user$project$Charty_Color$assignDefaults, labelPrecision: 2, drawLabels: true};
var _user$project$Charty_LineChart$Series = F2(
	function (a, b) {
		return {label: a, data: b};
	});
var _user$project$Charty_LineChart$Config = F5(
	function (a, b, c, d, e) {
		return {drawPoints: a, background: b, colorAssignment: c, labelPrecision: d, drawLabels: e};
	});
var _user$project$Charty_LineChart$DrawingSettings = F3(
	function (a, b, c) {
		return {padding: a, transform: b, yLabels: c};
	});
var _user$project$Charty_LineChart$Padding = F4(
	function (a, b, c, d) {
		return {top: a, right: b, bottom: c, left: d};
	});
var _user$project$Charty_LineChart$DatasetBounds = F4(
	function (a, b, c, d) {
		return {xMin: a, xMax: b, yMin: c, yMax: d};
	});

var _user$project$Charty_PieChart$accumulateStart = F2(
	function (start, slices) {
		...
		if (_p0.ctor === '[]') {
			...
			return {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: start, _1: _p1},
				_1: A2(_user$project$Charty_PieChart$accumulateStart, start + _p1.percentage, _p0._1)
			};
		}
	});
var _user$project$Charty_PieChart$circumferencePoint = function (percentage) {
	var ang = (percentage * (2 * _elm_lang$core$Basics$pi)) / 100;
	return {
		ctor: '_Tuple2',
		_0: 500 * (1 + _elm_lang$core$Basics$sin(ang)),
		_1: 500 * (1 - _elm_lang$core$Basics$cos(ang))
	};
};
var _user$project$Charty_PieChart$drawSlice = F3(
	function (config, start, slice) {
		var largeArc = (_elm_lang$core$Native_Utils.cmp(slice.percentage, 50) < 1) ? '0' : '1';
		var _p2 = _user$project$Charty_PieChart$circumferencePoint(
			start + A2(_elm_lang$core$Basics$min, 99.9999, slice.percentage));
		var x2 = _p2._0;
		var y2 = _p2._1;
		var _p3 = _user$project$Charty_PieChart$circumferencePoint(start);
		var x1 = _p3._0;
		var y1 = _p3._1;
		var pathDefinition = function (_p4) {
			return A2(
				_elm_lang$core$String$join,
				' ',
		...
		return A2(
			_elm_lang$svg$Svg$path,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$fill(slice.color),
						_1: {ctor: '[]'}
					}
				}
			},
...
var _user$project$Charty_PieChart$drawSlices = F2(
	function (config, slices) {
		return A2(
			_elm_lang$svg$Svg$svg,
			{
			...
			A2(
				...
				_elm_lang$core$Basics$uncurry(
					_user$project$Charty_PieChart$drawSlice(config)),
				A2(_user$project$Charty_PieChart$accumulateStart, 0, slices)));
	});
var _user$project$Charty_PieChart$sumValues = A2(
	_elm_lang$core$List$foldr,
	F2(
		function (_p5, s) {
			var _p6 = _p5;
	...
	0);
var _user$project$Charty_PieChart$truncate = F2(
	function (maxGroupCount, dataset) {
		var _p7 = maxGroupCount;
		if (_p7.ctor === 'Nothing') {
			return dataset;
		} else {
			var _p9 = _p7._0;
			var _p8 = A2(_elm_lang$core$List$drop, _p9 - 1, dataset);
			if (_p8.ctor === '[]') {
				return dataset;
			} else {
				if (_p8._1.ctor === '[]') {
					...
					return A2(
						_elm_lang$core$Basics_ops['++'],
						A2(_elm_lang$core$List$take, _p9 - 1, dataset),
						{
							ctor: '::',
							_0: {
								label: 'Other',
								value: _user$project$Charty_PieChart$sumValues(_p8)
							},
							_1: {ctor: '[]'}
						});
				}
...
var _user$project$Charty_PieChart$normalize = function (dataset) {
	var sum = _user$project$Charty_PieChart$sumValues(dataset);
	return A2(
		_elm_lang$core$List$map,
		function (_p10) {
			var _p11 = _p10;
			return {label: _p11.label, value: (100 * _p11.value) / sum};
		},
		dataset);
};
var _user$project$Charty_PieChart$preprocess = F2(
	function (config, dataset) {
		return A2(
			_elm_lang$core$List$map,
			function (_p12) {
				var _p13 = _p12;
				return {color: _p13._0, label: _p13._1.label, percentage: _p13._1.value};
			},
			config.colorAssignment(
				A2(
					_user$project$Charty_PieChart$truncate,
					config.maxGroupCount,
					A2(
						...
						_user$project$Charty_PieChart$normalize(dataset)))));
	});
var _user$project$Charty_PieChart$label = function (s) {
	return {ctor: '_Tuple2', _0: s.color, _1: s.label};
};
var _user$project$Charty_PieChart$view = F2(
	function (config, dataset) {
		var slices = A2(_user$project$Charty_PieChart$preprocess, config, dataset);
		return A3(
			_user$project$Charty_Labels$withLabels,
			{background: config.background, labelsColor: config.labelsColor},
			A2(_elm_lang$core$List$map, _user$project$Charty_PieChart$label, slices),
			A2(_user$project$Charty_PieChart$drawSlices, config, slices));
	});
var _user$project$Charty_PieChart$defaults = {
	background: 'transparent',
	labelsColor: '#333333',
	maxGroupCount: _elm_lang$core$Maybe$Just(8),
	colorAssignment: _user$project$Charty_Color$assignDefaults
};
var _user$project$Charty_PieChart$Group = F2(
	function (a, b) {
		return {label: a, value: b};
	});
var _user$project$Charty_PieChart$Config = F4(
	function (a, b, c, d) {
		return {background: a, labelsColor: b, maxGroupCount: c, colorAssignment: d};
	});
var _user$project$Charty_PieChart$Slice = F3(
	function (a, b, c) {
		return {label: a, percentage: b, color: c};
	});

var _user$project$Layout$twoColumns = F2(
	function (controls, chart) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('demo-two-columns'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$LineChartExample$datasetDecoder = function () {
	var arrayToTuple = function (a) {
		var _p0 = _elm_lang$core$Array$toList(a);
		if (((_p0.ctor === '::') && (_p0._1.ctor === '::')) && (_p0._1._1.ctor === '[]')) {
			return _elm_lang$core$Json_Decode$succeed(
				{ctor: '_Tuple2', _0: _p0._0, _1: _p0._1._0});
		} else {
			return _elm_lang$core$Json_Decode$fail('Failed to decode point');
		}
	};
	var entryDecoder = A2(
		_elm_lang$core$Json_Decode$andThen,
	...
	return _elm_lang$core$Json_Decode$list(seriesDecoder);
}();
var _user$project$LineChartExample$encodeDataset = function (dataset) {
	var entryEncoder = function (_p1) {
		var _p2 = _p1;
	...
	var seriesEncoder = function (series) {
		return _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'label',
					_1: _elm_lang$core$Json_Encode$string(series.label)
				},
				_1: {
					ctor: '::',
					_0: {
						...
						_0: 'data',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, entryEncoder, series.data))
					},
					_1: {ctor: '[]'}
				}
			});
	};
	var datasetEncoder = function (_p3) {
		return _elm_lang$core$Json_Encode$list(
			A2(_elm_lang$core$List$map, seriesEncoder, _p3));
	};
	return A2(
		_elm_lang$core$Json_Encode$encode,
		4,
		datasetEncoder(dataset));
};
var _user$project$LineChartExample$sampleDataset = {
	ctor: '::',
	_0: {
		label: 'Series 1',
		data: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 100000, _1: 3},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 100001, _1: 4},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 100002, _1: 3},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 100003, _1: 2},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 100004, _1: 1},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 100005, _1: 1},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 100006, _1: -1},
									_1: {ctor: '[]'}
								}
							}
						}
	...
	_1: {
		...
		_0: {
			...
			data: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 100000, _1: 1},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 100001, _1: 2.5},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 100002, _1: 3},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 100003, _1: 3.5},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 100004, _1: 3},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 100005, _1: 2},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 100006, _1: 0},
										_1: {ctor: '[]'}
									}
								}
							}
		...
		_1: {
			...
			_0: {
				...
				data: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 100000, _1: 2},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 100001, _1: 1.5},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 100002, _1: 0},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 100003, _1: 3},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 100004, _1: -0.5},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 100005, _1: -1.5},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 100006, _1: -2},
											_1: {ctor: '[]'}
										}
									}
								}
...
var _user$project$LineChartExample$update = F2(
	function (msg, model) {
		var _p4 = msg;
		switch (_p4.ctor) {
			case 'DatasetChange':
				var _p6 = _p4._0;
				var _p5 = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$LineChartExample$datasetDecoder, _p6);
				if (_p5.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{input: _p6, inputOk: true, dataset: _p5._0}),
...
var _user$project$LineChartExample$init = {
	dataset: _user$project$LineChartExample$sampleDataset,
	input: _user$project$LineChartExample$encodeDataset(_user$project$LineChartExample$sampleDataset),
	inputOk: true,
	drawPoints: true,
	drawLabels: true
};
var _user$project$LineChartExample$Model = F5(
	function (a, b, c, d, e) {
		return {input: a, inputOk: b, dataset: c, drawPoints: d, drawLabels: e};
	});
var _user$project$LineChartExample$TogglePoints = {ctor: 'TogglePoints'};
var _user$project$LineChartExample$ToggleLabels = {ctor: 'ToggleLabels'};
var _user$project$LineChartExample$DatasetChange = function (a) {
	return {ctor: 'DatasetChange', _0: a};
};
var _user$project$LineChartExample$view = function (model) {
	var toggle = F3(
		function (msg, getter, field) {
			return A2(
							...
							_1: {
								...
								_1: {
									...
									_0: _elm_lang$html$Html_Attributes$id(
										A2(_elm_lang$core$Basics_ops['++'], 'toggle-', field)),
									_1: {
										ctor: '::',
						...
						_0: A2(
							...
							},
							{
								...
								_0: _elm_lang$html$Html$text(
									A2(_elm_lang$core$Basics_ops['++'], 'display ', field)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
	...
	var opacity = model.inputOk ? 1 : 0.3;
	var defaults = _user$project$Charty_LineChart$defaults;
	var chart = A2(
		_user$project$Charty_LineChart$view,
		_elm_lang$core$Native_Utils.update(
			defaults,
			{drawPoints: model.drawPoints, drawLabels: model.drawLabels}),
		model.dataset);
	return A2(
		_user$project$Layout$twoColumns,
		{
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$p,
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('The dataset below will be displayed on the right upon validation.'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('config-section'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						...
						_1: {
							...
							_0: A3(
								toggle,
								_user$project$LineChartExample$TogglePoints,
								function (_) {
									return _.drawPoints;
								},
								'points'),
							_1: {
								...
								_0: A3(
									toggle,
									_user$project$LineChartExample$ToggleLabels,
									function (_) {
										return _.drawLabels;
									},
									'labels'),
						...
						},
						{
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('dataset-editor'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$style(
												{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_user$project$LineChartExample$DatasetChange),
												_1: {ctor: '[]'}
											}
										}
									},
...
var _user$project$PieChartExample$eventDecoder = function () {
	var decodeFloat = function (s) {
	...
	return A2(_elm_lang$core$Json_Decode$andThen, decodeFloat, _elm_lang$html$Html_Events$targetValue);
}();
var _user$project$PieChartExample$currentValue = F2(
...
var _user$project$PieChartExample$label = function (group) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'Group ',
		_elm_lang$core$Basics$toString(group));
};
var _user$project$PieChartExample$update = F2(
	function (msg, model) {
		var _p2 = msg;
		switch (_p2._0.ctor) {
			case 'A':
...
var _user$project$PieChartExample$init = {groupA: 30, groupB: 40, groupC: 10, groupD: 20};
var _user$project$PieChartExample$Model = F4(
	function (a, b, c, d) {
		return {groupA: a, groupB: b, groupC: c, groupD: d};
	});
var _user$project$PieChartExample$D = {ctor: 'D'};
var _user$project$PieChartExample$C = {ctor: 'C'};
var _user$project$PieChartExample$B = {ctor: 'B'};
var _user$project$PieChartExample$A = {ctor: 'A'};
var _user$project$PieChartExample$buildDataset = function (model) {
	return {
		ctor: '::',
		_0: {
			label: _user$project$PieChartExample$label(_user$project$PieChartExample$A),
			value: model.groupA
		},
		_1: {
			ctor: '::',
			_0: {
				label: _user$project$PieChartExample$label(_user$project$PieChartExample$B),
				value: model.groupB
			},
			_1: {
				ctor: '::',
				_0: {
					label: _user$project$PieChartExample$label(_user$project$PieChartExample$C),
					value: model.groupC
				},
				_1: {
					ctor: '::',
					_0: {
						label: _user$project$PieChartExample$label(_user$project$PieChartExample$D),
						value: model.groupD
					},
					_1: {ctor: '[]'}
				}
...
var _user$project$PieChartExample$groupSlider = F2(
	function (model, group) {
		return A2(
			_elm_lang$html$Html$div,
			{
			...
			},
			{
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_user$project$PieChartExample$label(group)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_0: _elm_lang$html$Html_Attributes$value(
										_elm_lang$core$Basics$toString(
											A2(_user$project$PieChartExample$currentValue, model, group))),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html_Events$on,
											...
											A2(
												_elm_lang$core$Json_Decode$map,
												_user$project$PieChartExample$Update(group),
												_user$project$PieChartExample$eventDecoder)),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _user$project$PieChartExample$view = function (model) {
	var defaults = _user$project$Charty_PieChart$defaults;
	var colorAssignment = function (_p3) {
		return defaults.colorAssignment(
			A2(
				_elm_lang$core$List$sortBy,
				function (_p4) {
					var _p5 = _p4;
	...
	var chartConfig = _elm_lang$core$Native_Utils.update(
		defaults,
	...
	return A2(
		...
		{
			ctor: '::',
			_0: A2(_user$project$PieChartExample$groupSlider, model, _user$project$PieChartExample$A),
			_1: {
				ctor: '::',
				_0: A2(_user$project$PieChartExample$groupSlider, model, _user$project$PieChartExample$B),
				_1: {
					ctor: '::',
					_0: A2(_user$project$PieChartExample$groupSlider, model, _user$project$PieChartExample$C),
					_1: {
						ctor: '::',
						_0: A2(_user$project$PieChartExample$groupSlider, model, _user$project$PieChartExample$D),
						_1: {ctor: '[]'}
					}
				}
			}
		...
		A2(
			_user$project$Charty_PieChart$view,
			chartConfig,
			_user$project$PieChartExample$buildDataset(model)));
};

var _user$project$Main$samplePieChart = function () {
	var defaults = _user$project$Charty_PieChart$defaults;
	var dataset = {
		ctor: '::',
		_0: {label: 'Group A', value: 20},
		_1: {
			ctor: '::',
			_0: {label: 'Group B', value: 10},
			_1: {
				ctor: '::',
				_0: {label: 'Group C', value: 70},
				_1: {ctor: '[]'}
			}
		}
	};
...
var _user$project$Main$sampleLineChart = function () {
	var defaults = _user$project$Charty_LineChart$defaults;
	var dataset = {
		ctor: '::',
		_0: {
	...
	return A2(
		...
		_elm_lang$core$Native_Utils.update(
			defaults,
			{drawLabels: false, labelPrecision: 0, background: '#FFFFFF'}),
		dataset);
}();
...
var _user$project$Main$demoLink = F4(
	function (onClick, title, visual, description) {
		var linkAttributes = A2(
			_elm_lang$core$Maybe$withDefault,
			{ctor: '[]'},
			A2(
				_elm_lang$core$Maybe$map,
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('col s12 m4'),
				_1: linkAttributes
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('icon-block'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('center indigo-text'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('sample-chart valign-wrapper'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
...
var _user$project$Main$PieChartExampleMsg = function (a) {
	return {ctor: 'PieChartExampleMsg', _0: a};
};
var _user$project$Main$LineChartExampleMsg = function (a) {
	return {ctor: 'LineChartExampleMsg', _0: a};
};
var _user$project$Main$NavigateToPieChart = {ctor: 'NavigateToPieChart'};
var _user$project$Main$NavigateToLineChart = {ctor: 'NavigateToLineChart'};
var _user$project$Main$landing = A2(
	...
	{ctor: '[]'},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('indigo darken-1'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('header center'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Charty'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('row center'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('header col s12 light'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('A simple SVG charts library for Elm.'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('row center links'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$href('http://package.elm-lang.org/packages/juanedi/charty/latest'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('btn-large indigo'),
														_1: {ctor: '[]'}
													}
												},
												{
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$href('https://github.com/juanedi/charty'),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('btn-large indigo'),
															_1: {ctor: '[]'}
							...
							},
							{
								...
								_0: A2(
									...
									},
									{
										ctor: '::',
										_0: A4(
											_user$project$Main$demoLink,
											_elm_lang$core$Maybe$Just(_user$project$Main$NavigateToLineChart),
											'Line charts',
											_user$project$Main$sampleLineChart,
											'Visualize single or multiple series with their corresponding labels.'),
										_1: {
											ctor: '::',
											_0: A4(
												_user$project$Main$demoLink,
												_elm_lang$core$Maybe$Just(_user$project$Main$NavigateToPieChart),
												'Pie charts',
												_user$project$Main$samplePieChart,
												'Use these to compare proportions of different slices of your data.'),
											_1: {
												ctor: '::',
												_0: A4(
													_user$project$Main$demoLink,
													_elm_lang$core$Maybe$Nothing,
													'More coming',
													_user$project$Main$icon('add'),
													'Bars, stacked series, deeper customization comming soon.'),
												_1: {ctor: '[]'}
											}
										}
									}),
...
var _user$project$Main$NavigateToLanding = {ctor: 'NavigateToLanding'};
var _user$project$Main$example = F2(
	function (currentMenuLink, content) {
		var menuItem = F2(
			function (link, label) {
				return A2(
						...
						_0: _elm_lang$html$Html_Attributes$classList(
							{
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'active',
									_1: _elm_lang$core$Native_Utils.eq(link, currentMenuLink)
								},
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					},
					{
						...
						_0: A2(
							_elm_lang$html$Html$a,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(link),
									_1: {ctor: '[]'}
								}
							},
							{
			...
			{ctor: '[]'},
			{
							...
							},
							{
								...
								_0: A2(
									_elm_lang$html$Html$a,
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$NavigateToLanding),
												_1: {ctor: '[]'}
											}
										}
									},
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: A2(menuItem, _user$project$Main$NavigateToLineChart, 'Line Chart'),
											_1: {
												ctor: '::',
												_0: A2(menuItem, _user$project$Main$NavigateToPieChart, 'Pie Chart'),
												_1: {ctor: '[]'}
											}
										}),
									_1: {ctor: '[]'}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('section container chart-demo'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$Main$view = function (model) {
	...
	switch (_p0.ctor) {
		...
		case 'LineChartExample':
			return A2(
				_user$project$Main$example,
				_user$project$Main$NavigateToLineChart,
				A2(
					_elm_lang$html$Html$map,
					_user$project$Main$LineChartExampleMsg,
					_user$project$LineChartExample$view(_p0._0)));
		default:
			return A2(
				_user$project$Main$example,
				_user$project$Main$NavigateToPieChart,
				A2(
					_elm_lang$html$Html$map,
					_user$project$Main$PieChartExampleMsg,
					_user$project$PieChartExample$view(_p0._0)));
	}
};
var _user$project$Main$PieChartExample = function (a) {
	return {ctor: 'PieChartExample', _0: a};
};
var _user$project$Main$LineChartExample = function (a) {
	return {ctor: 'LineChartExample', _0: a};
};
var _user$project$Main$Landing = {ctor: 'Landing'};
var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Main$Landing, _1: _elm_lang$core$Platform_Cmd$none};
			...
			if (_p1.ctor === '_Tuple2') {
				switch (_p1._1.ctor) {
					case 'NavigateToLanding':
						return {ctor: '_Tuple2', _0: _user$project$Main$Landing, _1: _elm_lang$core$Platform_Cmd$none};
					case 'NavigateToLineChart':
						return {
							ctor: '_Tuple2',
							_0: _user$project$Main$LineChartExample(_user$project$LineChartExample$init),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					case 'NavigateToPieChart':
						return {
							ctor: '_Tuple2',
							_0: _user$project$Main$PieChartExample(_user$project$PieChartExample$init),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					case 'LineChartExampleMsg':
						if (_p1._0.ctor === 'LineChartExample') {
							return A2(
								_elm_lang$core$Tuple$mapSecond,
								_elm_lang$core$Platform_Cmd$map(_user$project$Main$LineChartExampleMsg),
								A2(
									_elm_lang$core$Tuple$mapFirst,
									_user$project$Main$LineChartExample,
									A2(_user$project$LineChartExample$update, _p1._1._0, _p1._0._0)));
						} else {
							break _v1_5;
						}
					default:
						if (_p1._0.ctor === 'PieChartExample') {
							return A2(
								_elm_lang$core$Tuple$mapSecond,
								_elm_lang$core$Platform_Cmd$map(_user$project$Main$PieChartExampleMsg),
								A2(
									_elm_lang$core$Tuple$mapFirst,
									_user$project$Main$PieChartExample,
									A2(_user$project$PieChartExample$update, _p1._1._0, _p1._0._0)));
						} else {
							break _v1_5;
						}
				}
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"PieChartExample.Msg":{"args":[],"tags":{"Update":["PieChartExample.Group","Float"]}},"LineChartExample.Msg":{"args":[],"tags":{"TogglePoints":[],"DatasetChange":["String"],"ToggleLabels":[]}},"PieChartExample.Group":{"args":[],"tags":{"A":[],"D":[],"B":[],"C":[]}},"Main.Msg":{"args":[],"tags":{"NavigateToPieChart":[],"NavigateToLanding":[],"LineChartExampleMsg":["LineChartExample.Msg"],"NavigateToLineChart":[],"PieChartExampleMsg":["PieChartExample.Msg"]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
